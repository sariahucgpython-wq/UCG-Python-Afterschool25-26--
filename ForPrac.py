"""
Python For-Loop Assignments (Student Version)
--------------------------------------------
Complete each of the following assignments. Do NOT include solutions in this file.
Produce your own Python code beneath each prompt.
"""
